 ...
 * - 큰 카드 순서는 BenefitAlertCard -> TaxTemperatureCard -> KnowledgeBiteCard로 유지한다.
...
import { BenefitAlertCard, KnowledgeBiteCard, TaxTemperatureCard } from '../../components/HomeCards.jsx';
...
export function HomePage() {
  ...
  return (
    <section className="main2-page" aria-label="메인 페이지">
      ...
      <TaxTemperatureCard temperature={homeData.taxTemperature} calendar={homeData.calendar} personaId={personaId} />
