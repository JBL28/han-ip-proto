  ...
  hanbeoteam: {
    ...
    recommendations: [
      ...
      },
      {
        ...
        detailPage: 'deduction-detail',
        detailId: 'single-parent-income-deduction',
        source: 'mockdatas/index.md > 한버팀 > 메인페이지 > 절세(혜택) 추천 항목 3개',
      },
      {
        type: 'deduction',
    ...
    knowledge: {
      title: [
        { text: '취학 전 아동 ' },
        { text: '학원비/체육시설 수강료', highlight: true },
        { text: ' ' },
  ...
  kimgatsaeng: {
    ...
    recommendations: [
      ...
      },
      {
        ...
        detailPage: 'deduction-detail',
        detailId: 'housing-savings-deduction',
        source: 'mockdatas/index.md > 김갓생 > 메인페이지 > 절세(혜택) 추천 항목 3개',
      },
      {
        type: 'deduction',
        ...
        detailPage: 'deduction-detail',
        detailId: 'hometown-donation-credit',
        source: 'mockdatas/index.md > 김갓생 > 메인페이지 > 절세(혜택) 추천 항목 3개',
      },
    ],
    knowledge: {
